 ...
 *
 * Combat tuning target (20260926): standard enemy TTK ≈ 10s,
 * player TTD ≈ 20s under baseline 1v1 conditions.
 */
...
export function threatFromInvadeSector(opts: { density: number | null; engage?: "forced" | "raid" | null; enemyCells?: readonly { sx: number; sy: number }[]; neighborCount?: number }): DensityThreat {
  if (opts.engage === "forced" || opts.engage === "raid") {
    return threatFromEngage({ density: opts.density, engage: opts.engage, enemyCells: opts.enemyCells, neighborCount: opts.neighborCount });
  }
